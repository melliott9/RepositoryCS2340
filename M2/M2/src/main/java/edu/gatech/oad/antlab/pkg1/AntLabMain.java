 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("McKenzie Elliott");
		  toPrint += p1.toString("melliott9");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Sara Norris");
		  toPrint += p2.toString("snorris31");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alexandra Link");
		  toPrint += p3.toString("alink3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Mani Japra");
          toPrint += p4.toString("mjapra3");
